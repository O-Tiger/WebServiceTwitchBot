...
from app.database.models import (
    User, Message, AutoResponse, StreamerConfig, 
    Log, BotConfig, SystemConfig
)
...
class UserCRUD:
    ...
    def create(self, username: str, channel: str, points: int = 0, 
    ...
    def get_top_users(self, channel: str, limit: int = 10, 
                      order_by: str = 'points') -> List[Dict]:
...
class MessageCRUD:
    ...
    def create(self, username: str, channel: str, message: str, 
...
class AutoResponseCRUD:
    ...
    def create(self, trigger: str, response: str, 
               channel: Optional[str] = None, enabled: bool = True) -> int:
    ...
    def get_by_trigger(self, trigger: str, channel: Optional[str] = None) -> Optional[Dict]:
    ...
    def get_all(self, channel: Optional[str] = None, enabled_only: bool = True) -> List[Dict]:
    ...
    def update(self, response_id: int, response: str = None, 
...
class StreamerCRUD:
    """Operações CRUD para streamers"""
    
    def __init__(self, db_manager: DatabaseManager):
        self.db = db_manager
    
    def create(self, username: str, display_name: str = None, 
               auto_connect: bool = False, enabled: bool = True) -> int:
    ...
    def get_all(self, enabled_only: bool = False) -> List[Dict]:
        """Retorna todos streamers"""
        with self.db.get_connection() as conn:
    ...
    def delete(self, streamer_id: int) -> bool:
        """Deleta streamer"""
        with self.db.get_connection() as conn:
...
class BotDatabase:
    ...
    def __init__(self, db_path: str = "database/bot_data.db"):
        ...
        self.streamers = StreamerCRUD(self.manager)
